...
final class ProgressionTests: XCTestCase {
    ...
    func testStarGradeScalesStatsButNotSpeed() {
        let blueprint = UnitDatabase.zeus
    ...
    func testExperienceCannotPushPastGradeCap() {
        var unit = Unit(blueprint: UnitDatabase.zeus, level: 1, stars: 3)
    ...
    func testEvolutionRequiresMaxLevelAndFodder() {
        var unit = Unit(blueprint: UnitDatabase.zeus, level: 1, stars: 5)
        var wallet = Wallet()
        ...
        let fodder = (0..<5).map { _ in Unit(blueprint: UnitDatabase.zeus, level: 1, stars: 5) }
    ...
    func testAwakeningConsumesEssenceExactlyOnce() {
        var unit = Unit(blueprint: UnitDatabase.zeus, level: 1, stars: 5)
        var essences = UnitDatabase.zeus.awakening!.essenceCost
