...
extension UnitDatabase {
    ...
    static func family(_ row: FamilyRow, element: Element) -> UnitBlueprint {
        ...
        let awakening: Awakening? = common ? nil : Awakening(
            ...
            skillOverrides: [:],
            // The one recipe, by the row's natural grade (`awakeningCost`).
            essenceCost: awakeningCost(element: element, naturalStars: row.stars)
        )
...
extension UnitDatabase {
    ...
    static let elementalSkillNames: [String: [String]] = [
        "horus": ["Talon of the Dawn", "Talons of the Flood", "Fourfold Stoop", "Eye of Horus", "Black Moon Talon", "Wings of the Sun", "Stoop of the Flood", "Sky-Rider's Dive", "Pharaoh's Verdict", "Vengeance for Osiris"],
        "isis": ["Warmth of the Kiln", "Balm of the Inundation", "Kite-Wing Lift", "Knot of Isis", "Serpent's Bargain", "Breath of Life", "Refuge of the Marsh", "Kite Takes Wing", "Words of Power", "Spell of Unbinding"],
        "set": ["Red Land Claw", "Coffin on the Nile", "Sandstorm Snatch", "Sun-Guard's Spear", "Brother's Betrayal", "Red Land Blaze", "Nile Drowning", "Chaos Unbound", "Spear at the Prow", "Eighty Years' War"],
        "bastet": ["Hearth-Coal Claws", "Delta Pounce", "Cat's Pounce", "Lioness Remembered", "Night-Cat's Bite", "Sickles at the Hearth", "Reed-Bed Ambush", "Whirl of Sickles", "Bubastis Sunburst", "Night Hunt"],
        "sobek": ["Scalding Shallows Slam", "River's Roar", "Reed-Bank Rush", "Sunning on the Bank", "Bite from Below", "Scalded Jaws", "Death Roll", "Reed Tail Sweep", "Pharaoh's Protector", "Taker of the Drowned"],
        "hathor": ["Red Beer Stupor", "Sistrum of the Flood", "Song of the Sycamore", "Sun-Horn Glare", "Evening Lullaby", "Bright-Flame Dance", "Sky-Cow's Milk", "Sistrum Whirl", "Golden Revel", "Sekhmet's Shadow"],
        "scarab_knight": ["Sun-Ball Charge", "Carapace Wall", "Wing-Case Whir", "Khepri's Blessing", "Sealed Tomb Grip", "Khepri Rising", "Cold Vault Strike", "Beetle-Horn Challenge", "Sealed Against Centuries", "Grave-Guard's Grudge"],
        "mummy": ["Smouldering Wrappings", "Natron Chill", "Unravelling Rush", "Stolen Amulets", "Curse of the Tomb", "Pyre of the Forgotten", "Embalmer's Cold", "Mouthful of Dust", "Warning on the Door", "Rot Beneath the Linen"],
        "jackal_warrior": ["Twin Pyre Cuts", "Grave-Cold Blow", "Scavenger's Flurry", "Mask of the Master", "Duat Lunge", "Necropolis Torch Sweep", "Cold Tomb Sweep", "Run of the Pack", "Honour Guard's Sweep", "Where the Dead Are"],
        "athena": ["Promachos Charge", "Aegis Wall", "Owl-Wing Muster", "Parthenos' Mantle", "Night-Owl Talon", "Olive-Crown Rally", "Harbour-Chain Thrust", "The Planned War", "Gorgon Shield", "Medusa's Head Bared"],
        "poseidon": ["Boiling Sea Slam", "Tidal Roar", "Storm-Horse Charge", "Sea-Wall Stance", "Drowned Men's Due", "Earthshaker", "Drink of the Abyss", "Storm-Bringer's Surge", "Trident of the Shallows", "Grudge of the Deep"],
        "hades": ["Phlegethon Lash", "Toll of the Styx", "Unseen Step", "Plouton's Levy", "Cap of Invisibility", "Tartarus Kindled", "Lethe's Forgetting", "Hush of the Shades", "Judgement Below", "Gates of Erebus"],
        "apollo": ["Paean", "Delian Spring", "Lyre's Quickening", "Veil of Phoebus", "Plague Arrow", "Gift of Asclepius", "Hymn of Delos", "Chase of the Laurel", "Delphic Clarity", "Python Slain"],
        "artemis": ["Twin Torch Arrows", "Hunter's Volley", "Five from the Hills", "Phosphoros Shaft", "Stag-Maker's Shot", "Torchlit Drive", "Volley Over the Lake", "Hounds Loosed", "Rain of the Moon", "Niobe's Daughters"],
        "hermes": ["Hearth-Road Ambush", "Toll at the Ford", "Winged Word", "Message of Olympus", "Argus Lulled", "Thief's Dawn", "Serpent-Staff Balm", "Talaria Rush", "Herald's Call", "Psychopomp's Summons"],
        "minotaur": ["Brazen Bull Slam", "Bellow in the Maze", "Bull Rush", "Tribute Demanded", "Fed on Tribute", "Horn Through Bronze", "Feast of Fourteen", "Maze-Wide Stampede", "Asterion's Stand", "Theseus Denied"],
        "cyclops": ["Twin Forge Blows", "Boulder Heave", "Three Blind Swings", "One Eye Open", "Sailor's Supper", "Forge-Blast Sweep", "Rockfall on the Shore", "Nobody's Fury", "Smith of Thunderbolts", "Blinded Rage"],
        "amazon": ["Scorched Grass Charge", "Thermodon Cuts", "Horseback Flurry", "Crescent Guard", "Blood-Price Cut", "Hippolyta's Wrath", "River-Ford Strike", "Ride-By Cut", "Daughter of Ares", "Cost of the Belt"],
        "medusa": ["Petrifying Gaze", "Stone-Cold Stare", "Hiss of a Hundred", "Priestess' Glare", "Snake-Hair Lullaby", "Gorgon Sisters' Rally", "Stone Sisters' Shelter", "Winged Sisters", "Head Held High", "Eyes That Remain"],
        "odin": ["Between Two Pyres", "Draught of Mimir's Well", "Word of the Runes", "Grimnir's Unmasking", "Sleep-Thorn", "Spear Over the Host", "Price of the Well", "Wild Hunt", "Ravens' Morning Report", "Nine Nights Hanged"],
        "thor": ["Twin Hammer Blows", "Hook for the Serpent", "Hammer Comes Back", "Thunder Crack", "Feast of the Goats", "Giant-Slayer", "Midgard Sea Swell", "Storm-Rider's Sweep", "Vingthor's Thunder", "Nine Steps"],
        "freya": ["Warmth of Sessrúmnir", "Tears of Gold", "Falcon Cloak Lent", "Necklace's Gleam", "Seiðr Drain", "Fólkvangr", "Amber Sea Calm", "Falcon-Winged Rush", "Vanadís' Blessing", "Long Night Seiðr"],
        "loki": ["Flame-Tongue Cut", "Net of the Salmon", "Shape-Shift", "Bright-Lie Bargain", "Sif's Shorn Hair", "Contest with Logi", "Chains of Entrails", "Lokasenna", "Every Gift a Trick", "Bound Serpent"],
        "tyr": ["Oath-Brand Slam", "Challenge at the Ford", "Spear-Rune Charge", "Wolf's Bargain", "Garm's Due", "Sworn Blow", "Price of Binding", "Left-Hand Sweep", "Thing-Keeper", "Bite Remembered"],
        "heimdall": ["Beacon-Blade Riposte", "Nine Waves' Shelter", "Hears the Grass Grow", "Bifrost Ward", "Long Watch Cut", "Gjallarhorn", "Sea-Born Strike", "Sentinel's Challenge", "Gold-Tooth Stand", "Last Duel with Loki"],
        "hel": ["Pyre-Ash Grasp", "Gjöll's Chill", "Sleet-Cold Snatch", "Pale Dawn Reckoning", "Corpse-Gate", "Plate of Hunger", "Frozen River Crossing", "Sunless Hall Hush", "Baldr Kept", "Nágrindr"],
        "skadi": ["Blood-Price Shots", "Skater's Volley", "Blizzard-Born Barrage", "Bright Snow Shaft", "Winter Night Shot", "Thiazi's Vengeance", "Avalanche", "Ski-Run Volley", "Chosen by the Feet", "Snowbound Sleep"],
        "valkyrie": ["Pyre-Bound Thrust", "Swan-Maiden Cuts", "Ride Over the Field", "Chooser's Cut", "Marked for the Hall", "Spear for Valhalla", "Weighed and Found Wanting", "Wings Over the Slain", "Odin's Choice", "Taken to the Hall"],
        "draugr": ["Barrow-Torch Swing", "Barrow Shield", "Restless Rising", "Grave-Gold Ward", "Heavier Than Living", "Hoard-Guard Rally", "Cold Mound Blow", "Not Staying Down", "Hard to Kill Twice", "Meaner Dead"],
        "berserker": ["Bear Rage", "Shield-Biter's Blow", "Frothing Flurry", "Feels No Wound", "Pelt Takes Over", "Not Entirely a Man", "Bear-Hug Sweep", "Wolf-Coat Whirl", "Frenzy Unclouded", "Night of the Bear-Shirt"],
        "frost_troll": ["Sun-Scorched Slam", "Glacier Roar", "Moraine Charge", "Stone-Skin Stand", "Under-Ice Bite", "The Only Argument", "Glacier's Gulp", "Crevasse Sweep", "Turned to Stone", "Cold Under the Mountain"],
        "dwarf_smith": ["Anvil Ring", "Slag Pour", "Bellows Blast", "Ivaldi's Gleam", "Forge-Smoke Lull", "Forge Blessing", "Tempered Iron", "Skidbladnir Unfolded", "Three Treasures Made", "Paid in Tricks"],
        "ra": ["Twin Noon Spears", "Solar Barque", "Sky-Barque Salvo", "Aten's Ray", "Twelfth Hour Shot", "Burning Noon Volley", "Volley of the West", "Hours Hastened", "Sun-Disc Ascendant", "Night Barque"],
        "osiris": ["Reed-Torch Rally", "Nile Rising", "Breath of the West", "Wennefer's Grace", "Flail of the Silent", "Made Whole Again", "Field of Reeds", "Harvest Come Early", "Djed Raised", "Long Night's Judgement"],
        "ptah": ["Kiln-Blast", "Nile Clay Weight", "Word Withheld", "Truth Spoken Plain", "Workshop Lamps Out", "Hammer of Memphis", "Clay Made Firm", "Bellows Quickening", "Opening of the Mouth", "Unmaking Word"],
        "khnum": ["Kiln-Hot Horns", "Potter's Wheel", "High Desert Drive", "Dawn Glaze", "Ram in the Cavern", "Kiln-Baked Bulwark", "Source of the Nile", "Ram's Head Lowered", "Shaper's Stand", "Cavern Keeper's Mark"],
        "nephthys": ["Pyre Mourning", "Salt Marsh Veil", "Kite-Wing Snatch", "Dusk Lament", "Veil of the House", "Wail Over the Pyre", "Tears of the Marsh", "Kite's Cry", "Mourning Sister's Verdict", "Hidden House Curse"],
        "maat": ["Lamp-Lit Resolve", "Still Pool Balm", "Feather on the Scale", "Clear Sky Blessing", "Weighing of Hearts", "Heart Returned", "Order Restored", "Feather Lifts All", "Clear Sky Verdict", "Silent Hall Sentence"],
        "serqet": ["Hot Sand Sting", "Delta Numbing", "Dust Storm Dart", "Noon Glare Lash", "Tomb-Scorpion's Grip", "Seven Scorpions", "Venom Slows the Blood", "Breath Taken Away", "Glare of the Scorpion", "Venom of the Sands"],
        "taweret": ["Sunbaked Wallow", "Bellow of the Reeds", "Faster Than She Looks", "Stand Before the Cradle", "Night River Maw", "Lion-Paw Crush", "Great One's Bulk", "Crocodile-Back Sweep", "Fierce to All Others", "Night River Drag"],
        "anhur": ["Thinis Spear-Thrust", "Cataract Cuts", "Four Plumes", "High Sun Spear", "Far Desert Mark", "Lion Hunt", "Bringer Back", "Chase Southward", "Sun's Daughter Returned", "Far Desert Ending"],
        "bes": ["Face That Scares Demons", "Tongue-Out Taunt", "Drum Drowns Them Out", "Mane-Shake Glare", "Childbed Lullaby", "Lion-Maned Revel", "Dance of the Household", "Bandy-Legged Jig", "Demons Kept Off", "Grimace of Bes"],
        "medjay": ["Two for the Tomb-Robber", "Patrol Volley", "Nubian Quick-Draw", "Pharaoh's Warrant", "Tomb-Road Ambush", "Desert Road Cleared", "Oasis Volley", "Guard Worth Hiring", "Scouts' Signal", "Marked by the Patrol"],
        "cobra_priestess": ["Wrath of the Uraeus", "Venom Drawn Out", "Hood Spread Wide", "Uraeus Blessing", "Bite That Mends", "Wadjet's Rekindling", "Coil Around the Crown", "Quick as a Strike", "Crown-Serpent's Grace", "Venom Spat Back"],
        "hera": ["Wife's Fury Loosed", "Argive Shore Pull", "Mountain Air Hush", "Hundred Eyes", "Jealous Night Hex", "Hearth-Rite Rally", "Shore-Temple Refuge", "Peacock Fan Unfurled", "Queen's Decree", "Madness Sent"],
        "hephaestus": ["Furnace-Tong Riposte", "Bronze Bulwark", "Bellows Roused", "Bright Bronze Plating", "Deep Forge Hammer", "Arms for the Heroes", "Cooling Trough Quench", "Lame God's Grudge", "Thrown and Unbroken", "Net of Chains"],
        "demeter": ["Bread of the Earth", "Spring Rain", "Chaff Blown Off", "Golden Field Bounty", "Fallow Winter Sickle", "Persephone Returned", "Eleusinian Rite", "Search Over the World", "Harvest Blessing", "Nothing Grows"],
        "dionysus": ["Torchlit Thyrsus", "Pirates to Dolphins", "Mountain Dance Whirl", "Ivy Crown Stripped", "Midnight Rite Snare", "Revel", "Wine-Sodden Stupor", "Maenads Loosed", "Theatre of Fools", "Losing Your Mind"],
        "aphrodite": ["Struck Dumb by Beauty", "Foam-Born Languor", "Warm Breath Hush", "Charm", "Hidden Night Tryst", "Promise of Helen", "Sea-Foam Cradle", "Doves Released", "Irresistible", "Girdle of Desire"],
        "nike": ["Torch-Race Cut", "Salamis Cuts", "Four Wingbeats", "Laurel Strike", "Night Battle Cut", "Titan-War Charge", "Prow of Samothrace", "Victory Lap", "Wreath in Gold", "The Rout"],
        "achilles": ["Wrath", "River Fight Blow", "Swift-Footed Flurry", "Bright Bronze Glare", "For Patroclus", "Ships Ablaze", "Choking the River", "Chase Around Troy", "Shield of Hephaestus", "Hector Dragged"],
        "atalanta": ["Boar's First Blood", "Golden Apples", "Outrun Them All", "Suitor's Forfeit", "Hillside Foundling", "Calydonian Volley", "Arcadian Volley", "Footrace Volley", "Huntress Unwed", "Lions in the Temple"],
        "siren": ["Reef-Struck Chorus", "Song of the Rocks", "Feathered Chorus", "Sweet Unbearable Song", "Lull of the Reef", "Bird-Women's Chorus", "Island Refrain", "Wax in the Ears", "Heard and Lived", "Bones on the Shore"],
        "nymph": ["Warm Spring Draught", "Spring Blessing", "Rustle of the Grove", "Dryad's Bark", "Naiad's Undertow", "Sap Rises Again", "Drink from the Stream", "Oread's Mountain Air", "While the Tree Lives", "Stream Run Dry"],
        "baldr": ["Bright Hearth Warmth", "Hringhorni's Calm", "Summer Come Early", "Unharmed", "Grief of the Gods", "Return After Ragnarök", "Every Oath Sworn", "Breidablik's Breeze", "Mistletoe Ward", "All Things Weep"],
        "frigg": ["Hearth-Spindle Snap", "Fensalir Mire", "Fate Told to None", "Foresight", "Long Night Spinning", "Asgard's Hearth", "Mother's Oath", "Falcon Cloak Borrowed", "Thread in Gold", "One Omission"],
        "surtr": ["Muspell's Twin Strokes", "Boiling Sea Blow", "Cinder Flurry", "Brighter Than the Sun", "Char-Black Cut", "World-Burner", "Scalding Sea Sweep", "Walk North", "Sword Like the Sun", "End of Things"],
        "njord": ["Beacon-Lit Oar", "Harbour Wall", "Sails Filled", "Bright Shallows Anchorage", "Undertow Oar", "Beacon on the Headland", "Deep Harbour Ice", "Gulls' Clamour", "Hostage of the Vanir", "Noatun Night Watch"],
        "idunn": ["Warm Orchard Cider", "Spring Well Draught", "Blossom Drift", "Apples of Youth", "Winter Store Raid", "Youth Restored", "Orchard Ward", "Carried Off and Back", "Golden Harvest of Asgard", "Giant Denied"],
        "sif": ["Stubble-Burn Cut", "Dew-Cold Cuts", "Four Sheaves", "Harvest Blade", "Shorn Night Cut", "Burning Field Strike", "Rowan Guard", "Scythe Through the Field", "Dwarf-Forged Gold", "Loki's Prank Repaid"],
        "ullr": ["Two Yew Shafts", "Snow Volley", "Whistling Fletch", "Snow Glare Shot", "Polar Night Shot", "Oath on the Ring", "Frozen Lake Volley", "Ski Charge", "Crossing on a Shield", "Winter's Weather"],
        "vidar": ["Ash-Heap Stamp", "Wordless Challenge", "Storm-Stride", "Silent Stand", "Wolf's Night Tread", "Boot of Every Scrap", "Survivor's Rest", "Storm-Wide Stamp", "New Dawn Standing", "Jaw-Breaker"],
        "fenrir": ["Red Fangs", "Lake Island Lunge", "Broken Fetter", "Sun-Chase Snap", "Tyr's Hand Taken", "Howl of Ash", "Gleipnir Strain", "Howling Loose", "Sun-Eater's Sweep", "Swallow the Sky"],
        "bragi": ["Tale That Stops Hearts", "Mead-Well Drowse", "Runes on the Tongue", "Golden Harp Chord", "Night's Saga Lull", "Hall-Song for the Slain", "Mead of Poetry", "Verse on the Wing", "Skald's Welcome", "Verse of Shame"],
        "einherjar": ["Fight Till Dusk", "Wall of the Hall", "Up at Dawn", "Valhalla's Ward", "Sæhrímnir's Feast", "Muster for Ragnarök", "Shield-Wall Chill", "Rise Again at Dusk", "Chosen Dead Stand", "Grudge Kept Till Dawn"],
    ...
    /// The eleven hand-written families' templates, chosen by hand as their
    /// skills were (`RegaliaTemplate`; a table family's is its kit's). The
    /// Scales judge, so Anubis's verdicts hold; the Eye's blow lands
    /// heavier; the Book heals; the clay figure and the bolt sharpen the
    /// crit; the Spear takes turns; the Pelt is worn under half; the Sandals
    /// are first off the mark; the Hoplon shields; the Pipes mend; the
    /// Talons snatch the bar.
    static let handwrittenRegaliaTemplates: [String: RegaliaTemplate] = [
        "anubis": .lastingWord,
        "sekhmet": .heavyHand,
        "thoth": .wellspring,
        "shabti": .keenEdge,
        ...
        "ares": .thiefOfTurns,
        "heracles": .unbowed,
        "perseus": .firstOffTheMark,
        "hoplite": .bulwark,
        "satyr": .wellspring,
        "harpy": .thiefOfTurns,
    ]

    /// Every family's regalia, NAMED in its own myth: the eleven hand-written
    /// families and every row of the table, by family key
    /// (`RegaliaService.familyKey`). The one creative task in the design; a
    /// family missing here has no regalia, and `RegaliaTests` refuses that.
    static let regaliaNames: [String: String] = [
        // ---- The eleven
        "anubis": "Scales of the Duat",
        "sekhmet": "Eye of Ra",
        "thoth": "Book of Thoth",
        "shabti": "Spell of the Sixth Chapter",
        "zeus": "Thunderbolt of Olympus",
        "ares": "Spear of Ares",
        "heracles": "Pelt of the Nemean Lion",
        "perseus": "Winged Sandals",
        "hoplite": "Hoplon of the Line",
        "satyr": "Pipes of the Wild",
        "harpy": "Talons of the Snatcher",
        // ---- Egypt
        "horus": "Eye of Horus",
        "isis": "Throne of Isis",
        "set": "Was-Sceptre of the Red Land",
        "bastet": "Aegis of Bubastis",
        "sobek": "Teeth of the Nile",
        "hathor": "Menat of Hathor",
        "scarab_knight": "Shell of the Sun-Roller",
        "mummy": "Linen of the Embalmer",
        "jackal_warrior": "Khopesh of the Necropolis",
        "ra": "Barque of a Million Years",
        "osiris": "Crook and Flail",
        "ptah": "Djed Staff of Ptah",
        "khnum": "Potter's Wheel of Elephantine",
        "nephthys": "Veil of the Hidden Sister",
        "maat": "Feather of Truth",
        "serqet": "Sting of Serqet",
        "taweret": "Sa-Knot of Taweret",
        "anhur": "Lance of Anhur",
        "bes": "Knife of the Household",
        "medjay": "Desert Bow of the Medjay",
        "cobra_priestess": "Uraeus of the Temple",
        // ---- Greece
        "athena": "Aegis of the Grey-Eyed",
        "poseidon": "Trident of the Earthshaker",
        "hades": "Helm of Darkness",
        "apollo": "Lyre of the Far-Shooter",
        "artemis": "Silver Bow of Artemis",
        "hermes": "Caduceus of the Herald",
        "minotaur": "Horns of Asterion",
        "cyclops": "Hammer of the Forge",
        "amazon": "War-Belt of the Thermodon",
        "medusa": "Serpent Crown of the Gorgon",
        "hera": "Peacock Diadem of Hera",
        "hephaestus": "Anvil of Lemnos",
        "demeter": "Golden Sheaf of Eleusis",
        "dionysus": "Thyrsus of the Vine",
        "aphrodite": "Cestus of Aphrodite",
        "nike": "Laurel of Nike",
        "achilles": "Ash Spear of Peleus",
        "atalanta": "Hide of the Calydonian Boar",
        "siren": "Song of the Shoals",
        "nymph": "Waters of the Naiad",
        // ---- Norse
        "odin": "Gungnir",
        "thor": "Mjölnir",
        "freya": "Brísingamen",
        "loki": "Sky-Shoes of Loki",
        "tyr": "Bound Hand of Tyr",
        "heimdall": "Gjallarhorn",
        "hel": "Gate of Helheim",
        "skadi": "Bow of Thrymheim",
        "valkyrie": "Swan-Feather Cloak",
        "draugr": "Grave-Gold of the Barrow",
        "berserker": "Bear-Shirt of the Chieftain",
        "frost_troll": "Hide of the Glacier",
        "dwarf_smith": "Tongs of Svartalfheim",
        "baldr": "Draupnir",
        "frigg": "Distaff of Fensalir",
        "surtr": "Sword of Muspell",
        "njord": "Anchor of Nóatún",
        "idunn": "Apples of Youth",
        "sif": "Hair of Gold",
        "ullr": "Yew Bow of Ýdalir",
        "vidar": "Iron Shoe of Vidar",
        "fenrir": "Jaws of Fenrir",
        "bragi": "Rune-Tongued Harp",
        "einherjar": "Shield of the Hall",
        "shield_maiden": "Seax of the Shield-Wall",
        "light_elf": "Lamp of Álfheim",
        "dark_elf": "Shadow Knife of the Deep",
        // ---- Rome
        "mars": "Spear of the Regia",
        "minerva": "Owl of Minerva",
        "neptune": "Trident of the Salt Tide",
        "pluto": "Bident of Dis",
        "diana": "Bow of Nemi",
        "mercury": "Winged Petasos",
        "bellona": "Whip of Bellona",
        "centurion": "Vitis of the Lost Legion",
        "gladiator": "Rudis of the Games",
        "vestal": "Hearth-Flame of Vesta",
        // ---- The Jade Court
        "sun_wukong": "Golden-Hooped Staff",
        "azure_dragon": "Dragon Pearl of the East",
        "nezha": "Wind-Fire Wheels",
        "guan_yu": "Green Dragon Crescent Blade",
        "chang_e": "Jade Rabbit's Elixir",
        "nuwa": "Five-Coloured Stones",
        "dragon_king": "Crown of the Four Seas",
        "fox_spirit": "Fox-Pearl of the Nine Tails",
        "jiangshi": "Forehead Talisman",
        "terracotta_soldier": "Halberd of the Buried Army",
    ]

    /// One line under each name: what the item is in the myth, and what it
    /// does here, in the same breath.
    static let regaliaBlurbs: [String: String] = [
        // ---- The eleven
        "anubis": "The scales on which every heart is weighed against a feather. A verdict given on them is not soon lifted: his debuffs hold.",
        "sekhmet": "The sun's own eye, sent out in a rage. What it looks on, it burns through: her blows land heavier when they land true.",
        "thoth": "The book that holds every spell the scribe of the gods ever wrote. Read from it and a wound closes further than it should.",
        "shabti": "The spell of the sixth chapter, painted on every clay figure: 'here I am'. The figure answers sharper the more of them are fed to it.",
        "zeus": "The bolt the forge-giants made him for the war against his father. It does not miss: the crit comes oftener.",
        "ares": "The spear that is never set down. Every rest is shorter with it in hand: his turns come sooner and his enemies' later.",
        "heracles": "The hide of the lion no blade could cut, worn as a cloak with the head for a hood. Under half health, nothing gets through it easily.",
        "perseus": "The sandals lent from the herald's own feet for one errand. He is in the air before the fight has begun.",
        "hoplite": "The round shield that covers half of him and half of the man beside him. The line's shields are broader for it.",
        "satyr": "The reed pipes cut on the hillside, played to make the wounded dance. His mending goes further.",
        "harpy": "The claws that took the blind king's supper off his table. What they snatch is time: her drains and gains on the bar are larger.",
        // ---- Egypt
        "horus": "The eye torn out in the fight for the throne and made whole again. Made whole, it sees the crit's mark: his heavy blows land heavier.",
        "isis": "The throne she wears for a crown, and the throne is her name. From it, her heals reach further.",
        "set": "The forked sceptre with the head of his own strange beast. Every turn he steals with it is a longer one.",
        "bastet": "The small shield with the cat's head on it that she carries with her sistrum. It guides the sickles: the crit comes oftener.",
        "sobek": "The jaws that close on what the river takes. Under half health his hide is the river's own: the defence holds.",
        "hathor": "The heavy beaded necklace shaken to bless a birth. What she says over it stays said: her debuffs hold.",
        "scarab_knight": "The beetle's shell that rolled the sun across the sky. The walls it raises are broader.",
        "mummy": "The natron-stiffened linen wound seven times. The turns it snatches are longer.",
        "jackal_warrior": "The curved sword of the necropolis guard. It finds the seam in the armour: the crit comes oftener.",
        "ra": "The boat that carries the sun through the day and the underworld by night. It is under way before the fight begins.",
        "osiris": "The shepherd's crook and the flail of the harvest, crossed on his chest. What they gather back is more.",
        "ptah": "The staff that is a pillar, a sceptre and the sign of life in one. The word spoken over it stands: his debuffs hold.",
        "khnum": "The wheel on which the ram-headed god threw every body ever born. The clay he raises around his allies is thicker.",
        "nephthys": "The veil of the sister who stands behind, unseen. The turns she takes from under it are longer.",
        "maat": "The feather against which every heart is weighed. Held up, it sets more right: her heals reach further.",
        "serqet": "The scorpion carried on the head of the goddess of stings. Every turn its venom steals is a longer one.",
        "taweret": "The knot of protection the hippopotamus goddess leans on. Under half health, it holds.",
        "anhur": "The lance of the god who went south and brought the lioness home. It strikes the heavy blow heavier.",
        "bes": "The knife the dwarf of the household waves at every evil thing that comes near a cradle. What he warns off stays off: his debuffs hold.",
        "medjay": "The bow of the desert police who guarded the tombs. It is drawn before the fight has begun.",
        "cobra_priestess": "The rearing cobra on the brow of the temple's priestess. Her mending goes further.",
        // ---- Greece
        "athena": "The goat-skin shield with the Gorgon's head on it. The walls she raises are broader.",
        "poseidon": "The three-pronged spear that shakes the earth and splits the sea. Under half health he is the sea itself: the defence holds.",
        "hades": "The helm that makes its wearer unseen. Every turn he takes from the dark is a longer one.",
        "apollo": "The lyre the herald traded him for a herd of cattle. Its music mends further.",
        "artemis": "The silver bow of the moon's huntress. The first arrow is off the string before the fight begins.",
        "hermes": "The winged staff with the two serpents wound round it. The word it carries stays: his debuffs hold.",
        "minotaur": "The bull's horns of the child of the labyrinth. Under half health, cornered, it holds.",
        "cyclops": "The hammer of the one-eyed smiths who forged the thunderbolt. It strikes true oftener.",
        "amazon": "The war-belt that a hero was sent to take from the queen. It guides the crescent blade: the heavy blow lands heavier.",
        "medusa": "The crown of living serpents. What their gaze fixes stays fixed: her debuffs hold.",
        "hera": "The diadem of the queen of the gods, with the eyes of her bird set in it. What she decrees stands: her debuffs hold.",
        "hephaestus": "The anvil of the lame smith of the gods. What he forges around his allies is thicker.",
        "demeter": "The sheaf of wheat from the first harvest. Her mending goes further.",
        "dionysus": "The pine-cone staff wound with ivy. Every turn it staggers from an enemy is a longer one.",
        "aphrodite": "The embroidered girdle that makes any heart do as she likes. What it makes them do, they keep doing: her debuffs hold.",
        "nike": "The wreath the winged goddess crowns the victor with. The finishing blow lands heavier.",
        "achilles": "The ash spear from the mountain that only he could lift. It finds the heel: the crit comes oftener.",
        "atalanta": "The hide of the great boar she drew first blood on. She is off the mark before the fight begins.",
        "siren": "The song that draws sailors onto the rocks. What it says, they cannot shake: her debuffs hold.",
        "nymph": "The spring of the water-nymph. Her mending goes further.",
        // ---- Norse
        "odin": "The spear that never misses, cut from the world tree. What it marks stays marked: his debuffs hold.",
        "thor": "The hammer that comes back to the hand that threw it. It finds the giant's skull oftener: the crit comes oftener.",
        "freya": "The necklace four dwarves made her, and the price she paid for it. Its light mends further.",
        "loki": "The shoes that run on air and water. Every turn he steals in them is a longer one.",
        "tyr": "The hand he gave the wolf so the gods could bind it. Under half health, the oath holds.",
        "heimdall": "The horn that will sound at the end of the world. The walls it calls up are broader.",
        "hel": "The gate of the hall of the dead, with a wall no living thing climbs. Every turn she takes at it is a longer one.",
        "skadi": "The bow of the giant's daughter who hunts on skis. The first shot is loosed before the fight begins.",
        "valkyrie": "The cloak of swan feathers the choosers of the slain fly in. The heavy blow lands heavier.",
        "draugr": "The gold buried with the dead man, which he will not give up. The walls he raises over it are broader.",
        "berserker": "The bear's pelt worn into battle in place of mail. The crit comes oftener.",
        "frost_troll": "The hide of the thing under the glacier. Under half health, the cold holds.",
        "dwarf_smith": "The tongs that held the hammer, the ring and the spear in the making. What they set stays set: his debuffs hold.",
        "baldr": "The ring that drips eight rings its own weight every ninth night, laid on the bright god's pyre. Its light mends further.",
        "frigg": "The distaff the queen of the gods spins the clouds on. What she spins stays spun: her debuffs hold.",
        "surtr": "The sword brighter than the sun that the fire-giant will burn the world with. The crit comes oftener.",
        "njord": "The anchor of the god of harbours and the sea-road. The walls he raises are broader.",
        "idunn": "The apples that keep the gods young. Her mending goes further.",
        "sif": "The hair of gold the dwarves spun her after hers was shorn. The heavy blow lands heavier.",
        "ullr": "The yew bow of the god of the winter hunt. The first arrow is off before the fight begins.",
        "vidar": "The shoe of every scrap of leather ever cut, thick enough to stand in the wolf's jaw. Under half health, it holds.",
        "fenrir": "The jaws that took a god's hand and will take the All-Father. The crit comes oftener.",
        "bragi": "The harp of the god of poetry, with runes cut on his tongue. What he sings stays sung: his debuffs hold.",
        "einherjar": "The shield of the chosen dead who fight every day in the hall. The walls it raises are broader.",
        "shield_maiden": "The short sword of the woman in the shield-wall. The heavy blow lands heavier.",
        "light_elf": "The lamp of the bright elves' home. Its light mends further.",
        "dark_elf": "The knife of the smiths who live under the ground. Every turn it steals is a longer one.",
        // ---- Rome
        "mars": "The spear kept in the king's old house that shook by itself before a war. The crit comes oftener.",
        "minerva": "The owl of the goddess of wisdom, which sees in the dark. What she says stands: her debuffs hold.",
        "neptune": "The trident of the god of the salt tide and the horse. The walls it raises are broader.",
        "pluto": "The two-pronged fork of the lord of the underworld's wealth. Every turn it takes is a longer one.",
        "diana": "The bow of the goddess of the grove by the lake. The first arrow is off before the fight begins.",
        "mercury": "The winged hat of the god of roads, thieves and messages. The heavy blow lands heavier.",
        "bellona": "The whip of the goddess of war, whose priests bled themselves in her name. Under half health, she holds.",
        "centurion": "The vine-staff of the centurion's office, cut on the backs of the ranks. The walls he raises are broader.",
        "gladiator": "The wooden sword that meant freedom, handed to the man who earned it. The crit comes oftener.",
        "vestal": "The flame that must never go out, tended by the virgins of the hearth. Its warmth mends further.",
        // ---- The Jade Court
        "sun_wukong": "The staff that was a pillar in the sea-dragon's palace and grows or shrinks at a word. Every turn it takes is a longer one.",
        "azure_dragon": "The pearl the dragon of the east chases through the clouds. It is chasing before the fight begins.",
        "nezha": "The wheels of wind and fire the boy-god rides on. The crit comes oftener.",
        "guan_yu": "The crescent blade of the god of war and loyalty, heavier than any man's. The walls he raises are broader.",
        "chang_e": "The elixir the moon's lady drank, and the rabbit that pounds it still. Its mending goes further.",
        "nuwa": "The stones of five colours she smelted to patch the sky. What she mends with them stays mended: her debuffs hold.",
        "dragon_king": "The crown of the king of the four seas. Under half health, the tide holds.",
        "fox_spirit": "The pearl in which the nine-tailed fox keeps its thousand years. Every turn she steals is a longer one.",
        "jiangshi": "The paper talisman on the brow that keeps the hopping dead in line. Torn off, the heavy blow lands heavier.",
        "terracotta_soldier": "The bronze halberd of the buried army, still sharp after two thousand years. The walls it raises are broader.",
    ]
}
